...
TelaDeAnamneseFisio telaDeAnamneseFisioFromJson(String str) => TelaDeAnamneseFisio.fromJson(json.decode(str));

String telaDeAnamneseFisioToJson(TelaDeAnamneseFisio data) => json.encode(data.toJson());

class TelaDeAnamneseFisio {
  TelaDeAnamneseFisio({
    this.id,
    this.idUsuario,
    this.nomeUsuario,
  ...
  factory TelaDeAnamneseFisio.fromJson(Map<String, dynamic> json) => TelaDeAnamneseFisio(
      id: json["id"],
