...
$anamnese_fisioterapia->setAnamnese($id_usuario,$db);

$anamnese_enfermagem = new anamneseEnfermagem("","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","","");
$anamnese_enfermagem->setAnamnese($id_usuario,$db);
...
<div class="container">
    <div class="row">
        <div class="col-sm-12 col-md-4 col-lg-4">
            <button class="btn btn-primary editar-dados botao botao-editar" id="editar-dados"> Editar dados pessoais</button>                
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4">
            <button class="btn btn-primary editar-anamnese-fisioterapia botao botao-editar" id="editar-anamnese-fisioterapia"> Editar dados para fisioterapia</button>                
        </div>
        <div class="col-sm-12 col-md-4 col-lg-4">
            <button class="btn btn-primary editar-anamnese-enfermagem botao botao-editar" id="editar-anamnese-enfermagem"> Editar dados para enfermagem</button>                
        </div>
    </div>
    <div class="separador"></div>
    <div class="form-editar-dados form-editar">
        <fieldset>    
            ...
            <div class="row form-group">
                ...
                <button class="btn btn-primary botao botao-enviar-editar">Editar</button>
            </div>
    ...
    <div class="separador"></div>
    <div class="form-editar-fisioterapia form-editar">
        <div class="separador"></div>
        <div class="row">
            ...
            <fieldset>    
                ...
                <div class="row form-group"> 
                    <div class="col-sm-12 col-md-12 col-lg-12">  
                        ...
                        <br>
                        <textarea class="form-control" name="queixa-principal" id="queixa-principal" required><?= $anamnese_fisioterapia->getQueixaPrincipal(); ?></textarea>
                    </div>                
                </div>
                <div class="row form-group"> 
                    <div class="col-sm-12 col-md-4 col-lg-4">  
                        ...
                        <br>
                        <input type="date" name="inicio" class="form-control" id="inicio" value="<?= $anamnese_fisioterapia->getInicio(); ?>">
                    </div>                                
                </div>
            </fieldset>        
            <fieldset>    
                ...
                <div class="row form-group"> 
                    <div class="col-sm-12 col-md-12 col-lg-12">  
                        ...
                        <input type="text" name="freq-exercicios" id="freq-exercicios" class="form-control freq-exercicios" placeholder="Com que frequência" value="<?= $anamnese_fisioterapia->getFreqExercicios() ?>">                
                    </div>                                
                </div>
                <div class="row form-group"> 
                    <div class="col-sm-12 col-md-12 col-lg-12">  
                        ...
                        <input type="text" name="freq-recreacao" id="freq-recreacao" class="form-control freq-recreacao" placeholder="Com que frequência" value="<?= $anamnese_fisioterapia->getDescRecreacao(); ?>">
                    </div>                                
                </div>                  
            </fieldset>
            <fieldset>    
    ...
    <div class="separador"></div>
    <div class="form-editar-enfermagem form-editar">
    <div class="row">
        <div class="col-sm-12 col-md-12 col-lg-12">
            <div class="row texto-centro">
                <h1 class="tituloColorido">Ficha de Pré-Avaliação</h1>
    ...
    <form class="formulario-cadastro" method="POST" action="<?= URL_BASE ?>controler/controler.php">
        <fieldset>    
            ...
            <div class="row form-group"> 
                <div class="col-sm-12 col-md-12 col-lg-12">  
                    <label for="queixa-principal"><span class="span-required">*</span>Queixas Principais:</label>
                    <br>
                    <textarea name="queixa-principal" id="queixa-principal" class="form-control" required><?= $anamnese_enfermagem->getQueixaPrincipal(); ?></textarea>
                </div>                
            </div>
            <div class="row form-group"> 
                <div class="col-sm-12 col-md-4 col-lg-4">  
                    <label for="inicio">Início:</label>
                    <br>
                    <input type="date" name="inicio" class="form-control" id="inicio" value="<?= $anamnese_enfermagem->getInicio(); ?>">
                </div>                                
            </div>
        </fieldset>
        <fieldset>    
            ...
            <div class="row form-group"> 
                <div class="col-sm-12 col-md-12 col-lg-12">  
                    ...
                    <br>
                    <input type="checkbox" name="doenca" id="doenca" value="cardiopatia" <?php if($anamnese_enfermagem->getDoenca() == "cardiopatia"){ echo "checked"; } ?>>Cardiopatia
                    <input type="checkbox" name="doenca" id="doenca" value="hipertensao" <?php if($anamnese_enfermagem->getDoenca() == "hipertensao"){ echo "checked"; } ?>>Hipertensão
                    <input type="checkbox" name="doenca" id="doenca" value="diabetes" <?php if($anamnese_enfermagem->getDoenca() == "diabetes"){ echo "checked"; } ?>>Diabetes
                    <input type="checkbox" name="doenca" id="doenca" value="cancer" <?php if($anamnese_enfermagem->getDoenca() == "cancer"){ echo "checked"; } ?>>Câncer
                    <input type="checkbox" name="doenca" id="doenca" value="outros" <?php if($anamnese_enfermagem->getDoenca() == "outros"){ echo "checked"; } ?>>Outros<input type="text" name="desc-doencas" id="desc-doencas" class="form-control desc-doencas">
                </div>                
            </div>
            <div class="row form-group"> 
                <div class="col-sm-12 col-md-12 col-lg-12">  
        ...
        <fieldset>    
            ...
            <div class="row form-group"> 
                <div class="col-sm-12 col-md-12 col-lg-12">  
                    ...
                    <input type="text" name="freq-recreacao" id="freq-recreacao" class="form-control freq-recreacao" placeholder="Com que frequência" value="<?= $anamnese_enfermagem->getDescRecreacao() ?>">                
                </div>                                
            </div>
            <div class="row form-group"> 
                <div class="col-sm-12 col-md-12 col-lg-12">  
        ...
        <fieldset>    
            ...
            <div class="row form-group"> 
                <div class="col-sm-12 col-md-12 col-lg-12">  
                    <label for="doencas-familia">Há alguma doença relacionada na familia:</label>
                    <input type="text" name="doencas-familia" id="doencas-familia" class="form-control doencas-familia" placeholder="Caso não haja, deixe o campo em branco" value=" <?= $anamnese_enfermagem->getDoencaFamilia(); ?>"> 
                </div>                
            </div>
            <div class="row form-group"> 
                <div class="col-sm-12 col-md-12 col-lg-12">  
                    <label for="tratamento-familia">Foi feito algum tratamento? Se sim, especifique:</label>
                    <input type="text" name="tratamento-familia" id="tratamento-familia" class="form-control tratamento-familia" placeholder="Caso não haja, deixe o campo em branco" value="<?= $anamnese_enfermagem->getTratamentoFamilia() ?>"> 
                </div>                           
            </div>            
        </fieldset>
        <div class="separador"></div>        
